...
public class FriendsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mFriendsList = (RecyclerView) mMainView.findViewById(R.id.friends_listId);
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Friends, FriendsViewHolder> friendsRecyclerViewAdapter = new
            ...
            protected void populateViewHolder(final FriendsViewHolder friendsViewHolder, Friends friends, int i) {
                ...
                mUsersDatabase.child(list_user_id).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        friendsViewHolder.setUsersThumbnail(userThumb,getContext());
    ...
    public static class FriendsViewHolder extends RecyclerView.ViewHolder{
        ...
        public void setDate(String date){
            ...
            TextView userNameView = (TextView) mView.findViewById(R.id.userStatusID);
