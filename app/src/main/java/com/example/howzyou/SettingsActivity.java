...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mImageView = (CircleImageView) findViewById(R.id.displayImageID);
        mName = (TextView) findViewById(R.id.settingsDisplayName);
        mStatus = (TextView) findViewById(R.id.settingStatusID);
        changeImageBtn = (Button) findViewById(R.id.changeImageButtonID);
        changeStatusBtn = (Button) findViewById(R.id.changeStatusButtonID);
        ...
        mUserDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
               ...
               if (!image.equals("default")) {
                   //Picasso.with(SettingsActivity.this).load(image).placeholder(R.drawable.addimage).into(mImageView);
                   Picasso.with(SettingsActivity.this).load(image).networkPolicy(NetworkPolicy.OFFLINE).
                           placeholder(R.drawable.addimage).into(mImageView, new Callback() {
                       @Override
...
//                        .start(SettingsActivity.this);
                        ...
                        if (task.isSuccessful()){
                            ...
                            uploadTask.addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                                ...
                                public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> thumb_task) {
                                    ...
                                    String thumbDownloadUrl = thumb_task.getResult().getMetadata().getReference().getDownloadUrl().toString();
    ...
    public static String random(){
        ...
        int randonLength = generator.nextInt(10);
        char tempChar;
        for (int i=0; i<randonLength; i++){
